<div id="main-left-2col-left" style="float: left;
  width: 22%;
  box-sizing: border-box;">
  <div class="nagivagtion-left">
    <div class="col s12">
      <div class="panel">
        <div class="panel-heading">
          <h3 class="panel-title">Dành cho phụ huynh</h3>
        </div>
      ...
      <div class="panel">
        <div class="panel-heading">
          <h3 class="panel-title">Dành cho gia sư</h3>
        </div>
        <div class="panel-body">
          <ul class="vertical-menu">
            <li class="nav-dropdown__link">
      ...
      <div class="panel">
        <div class="panel-heading">
        <h3 class="panel-title">Thông tin khác</h3> </div>
        <div class="panel-body">
          <ul class="vertical-menu">
            <li class="nav-dropdown__link">
